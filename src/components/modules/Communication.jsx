    ...
    <div>
      ...
      {tab==='compose'&&(
        <div style={{display:'grid',gridTemplateColumns:'1fr 320px',gap:16}}>
          <div style={{background:'#fff',border:'1px solid #F1F1F4',borderRadius:14,padding:'18px 20px',boxShadow:'0 1px 3px rgba(0,0,0,0.04)'}}>
            <div style={{fontSize:12,fontWeight:700,color:'#071437',textTransform:'uppercase',letterSpacing:'0.5px',marginBottom:14}}>Compose Email</div>
            <div style={{display:'flex',flexDirection:'column',gap:12}}>
              ...
              <button onClick={sendEmail} disabled={sending}
                style={{background:'#071437',color:'#fff',border:'none',borderRadius:9,padding:'9px 20px',cursor:'pointer',fontSize:13,fontWeight:700,display:'flex',alignItems:'center',gap:7,alignSelf:'flex-start',opacity:sending?0.6:1}}>
          ...
          {/* Templates */}
          <div style={{background:'#fff',border:'1px solid #F1F1F4',borderRadius:14,padding:'16px 18px',boxShadow:'0 1px 3px rgba(0,0,0,0.04)'}}>
            <div style={{fontSize:12,fontWeight:700,color:'#071437',textTransform:'uppercase',letterSpacing:'0.5px',marginBottom:12}}>Email Templates</div>
      ...
      {tab==='whatsapp'&&(
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:16}}>
          <div style={{background:'#fff',border:'1px solid #F1F1F4',borderRadius:14,padding:'18px 20px',boxShadow:'0 1px 3px rgba(0,0,0,0.04)'}}>
            <div style={{fontSize:12,fontWeight:700,color:'#071437',textTransform:'uppercase',letterSpacing:'0.5px',marginBottom:14}}>Share via WhatsApp</div>
            <div style={{display:'flex',flexDirection:'column',gap:12}}>
      ...
      {/* CONFIG */}
      {tab==='config'&&(
        <div style={{background:'#fff',border:'1px solid #F1F1F4',borderRadius:14,padding:'20px',boxShadow:'0 1px 3px rgba(0,0,0,0.04)'}}>
          <div style={{fontSize:12,fontWeight:700,color:'#071437',textTransform:'uppercase',letterSpacing:'0.5px',marginBottom:14}}>Email Configuration (Outlook / Microsoft 365)</div>
