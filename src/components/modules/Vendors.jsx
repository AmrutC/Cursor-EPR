            ...
            <div style={{ position:'relative', background:'#fff', borderRadius:18, width:'100%', maxWidth:900, maxHeight:'92vh', display:'flex', flexDirection:'column', boxShadow:'0 24px 64px rgba(0,0,0,0.22)' }}>
              ...
              <div style={{ flex:1, overflowY:'auto', padding:'18px 22px' }}>
                ...
                <div style={{ background:'#F8FAFC', border:'1px solid #E5E7EB', borderRadius:12, padding:'14px 16px', marginBottom:14 }}>
                  <div style={{ fontSize:10, fontWeight:700, color:'#0D1E35', textTransform:'uppercase', letterSpacing:'0.5px', marginBottom:12 }}>Requisition & Shipping Details</div>
                  <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(160px,1fr))', gap:12 }}>
                    <div>
                      <label style={{ display:'block', fontSize:10, fontWeight:700, color:'#4B5563', textTransform:'uppercase', letterSpacing:'0.5px', marginBottom:5 }}>Requesting Department</label>
                    ...
                    <div>
                      <label style={{ display:'block', fontSize:10, fontWeight:700, color:'#4B5563', textTransform:'uppercase', letterSpacing:'0.5px', marginBottom:5 }}>Requested By (Name)</label>
                      <input style={inp} value={poReqBy} onChange={e=>setPoReqBy(e.target.value)} placeholder="Full name of requester"/>
                    </div>
                    <div>
                      <label style={{ display:'block', fontSize:10, fontWeight:700, color:'#4B5563', textTransform:'uppercase', letterSpacing:'0.5px', marginBottom:5 }}>Shipping Method</label>
                    ...
                    <div>
                      <label style={{ display:'block', fontSize:10, fontWeight:700, color:'#4B5563', textTransform:'uppercase', letterSpacing:'0.5px', marginBottom:5 }}>Site Contact Person</label>
                      <input style={inp} value={poContactName} onChange={e=>setPoContactName(e.target.value)} placeholder="Name at delivery site"/>
                    </div>
                    <div>
                      <label style={{ display:'block', fontSize:10, fontWeight:700, color:'#4B5563', textTransform:'uppercase', letterSpacing:'0.5px', marginBottom:5 }}>Contact Mobile</label>
